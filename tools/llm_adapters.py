...
from .llm import LLMResponse, StreamStats, LLMToolResponse, ToolCall
...
class OpenAIAdapter(BaseLLMAdapter):
    ...
    def create_client(self) -> Any:
        ...
        try:
            ...
            raise Exception("使用OpenAI需要安装: pip install openai")
    ...
    async def astream_invoke(self, messages: List[Dict], **kwargs) -> AsyncIterator[str]:
        ...
        try:
            ...
            raise Exception(f"OpenAI API异步流式调用失败: {str(e)}")
    ...
    def invoke_with_tools(self, messages: List[Dict], tools: List[Dict],
        ...
        try:
            ...
            raise Exception(f"OpenAI Function Calling调用失败: {str(e)}")
...
class AnthropicAdapter(BaseLLMAdapter):
    ...
    def stream_invoke(self, messages: List[Dict], **kwargs) -> Iterator[str]:
        ...
        try:
            ...
            raise Exception(f"Anthropic API流式调用失败: {str(e)}")
    ...
    def invoke_with_tools(self, messages: List[Dict], tools: List[Dict], **kwargs) -> LLMToolResponse:
        ...
        try:
            ...
            raise Exception(f"Anthropic工具调用失败: {str(e)}")
...
class GeminiAdapter(BaseLLMAdapter):
    ...
    def stream_invoke(self, messages: List[Dict], **kwargs) -> Iterator[str]:
        ...
        try:
            ...
            raise Exception(f"Gemini API流式调用失败: {str(e)}")
    ...
    def invoke_with_tools(self, messages: List[Dict], tools: List[Dict], **kwargs) -> LLMToolResponse:
        ...
        try:
            ...
            raise Exception(f"Gemini工具调用失败: {str(e)}")
